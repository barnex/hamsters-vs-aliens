...
pub const ORANGE: vec3 = vec3(1.0, 0.5, 0.0);

pub const WHITE: vec3 = vec3(1.0, 1.0, 1.0);
pub const LIGHT_GREY: vec3 = vec3(0.75, 0.75, 0.75);
pub const GREY: vec3 = vec3(0.5, 0.5, 0.5);
pub const DARK_GREY: vec3 = vec3(0.25, 0.25, 0.25);
pub const BLACK: vec3 = vec3(0.0, 0.0, 0.0);

pub const MAGENTA: vec3 = vec3(1.0, 0.0, 1.0);
pub const BROWN: vec3 = vec3(0.5, 0.5, 0.0);
