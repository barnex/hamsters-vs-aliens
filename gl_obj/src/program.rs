...
impl Program {
	...
	/// Convenience constructor for a typical vertex + fragment shader program.
	//pub fn new_shader(vertex_src: &str, fragment_src: &str) -> Self {
	//Self::new(vec![Shader::new_vert(vertex_src), Shader::new_frag(fragment_src)])
	//}
